...
//-----------------------------------------------//
	...
	public function account_deactive()
	{
	   $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apimainmodel->account_deactive($user_id);
		$response = $data['result'];
		echo json_encode($response);
	}
...
//-----------------------------------------------//
	...
	public function request_to_activate()
	{
	  $_POST = json_decode(file_get_contents("php://input"), TRUE);
		...
		$data['result']=$this->apimainmodel->request_to_activate($email_or_mobile);
		$response = $data['result'];
		echo json_encode($response);
	}
...
//------------------User organiser Request-----------------------------//
	...
	public function user_organiser_request()
	{
