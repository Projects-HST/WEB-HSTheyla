               ...
               <div class="col-lg-8">
                  <div class="card m-b-20">
                     <div class="card-block">
                        ...
                        <form class="" method="post" action="<?php echo base_url();?>booking/add_plans" name="planform">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td><?php  echo $rows->seat_rate; ?></td>
								         <td><a href="<?php echo base_url();?>booking/edit_plan/<?php echo $rows->id;?>"><img title="Edit" src="<?php echo base_url();?>assets/icons/edit.png" /></a></td>
                              </tr>
                             <?php $i++;  }  ?>
                           </tbody>
                        </table>
...
//         },
//         messages: {
//         planname:"Select Teachers",
//         seats:"Select Classes",
//         amount:"Enter Title"
//                },
//       }); 
//    });
