				   ...
				   <div class="caption">
					 <a href="<?php echo base_url(); ?>eventlist/eventdetails/<?php echo $enc_event_id; ?>/<?php echo $res->event_name; ?>"><h4><?php echo $res->event_name; ?></h4></a>
						 <!-- <p class="plan_details"><?php //echo $string;?></p>-->
						  ...
						  <p class="plan_details">Booking Date : <?php $date=date_create($rows->show_date);
                                       echo date_format($date,"d-m-Y"); ?> <?php //echo $res->show_date; ?><a href="<?php echo base_url(); ?>home/user_booking_history/<?php echo $res->order_id; ?>/<?php echo $res->payment_gateway; ?>" class="btn btn-default btn-xs pull-right" role="button">
