        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-20">
                 ...
                 <h4 class="mt-0 header-title"> View Booking in Paytm </h4>
                ...
                <form method="post" enctype="multipart/form-data" action="" name="eventform">
                  <?php foreach($all as $rows){}?>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="Venue" class="col-sm-2 col-form-label">Trans type : </label>
                            <div class="col-sm-4">
                       ...
                       <div class="form-group row">
                            <label for="sdate" class="col-sm-2 col-form-label">Resp Code : </label>
                            <div class="col-sm-4">
                              <div class="input-group">
                                <h4 class="header-title"> <?php echo $rows->resp_code; ?> </h4>
                            </div>
                            </div>
                             <label for="edate" class="col-sm-2 col-form-label">Resp Msg : </label>
                            <div class="col-sm-4">
                               <div class="input-group">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                             ...
                             <label for="etime" class="col-sm-2 col-form-label">Trans _date: </label>
                            <div class="col-sm-4">
