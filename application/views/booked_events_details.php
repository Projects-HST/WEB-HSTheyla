...
<div class="col-md-12 ">
  ...
  <div class="card-block" style="padding:20px;">
			  ...
			  <div class="row" style="padding:5px;">
					...
					<div class="row" style="padding:5px;">
                        <div class="col-sm-3"><p class="summary_text">Mobile  : </p></div>
                        <div class="col-sm-3"><p class="summary_value"><?php echo $rows->mobile_no; ?></p></div>
                        <div class="col-sm-3"></div>
                    </div>
					<div class="row" style="padding:5px;">
                        <div class="col-sm-3"><p class="summary_text">Email  : </p></div>
