               ...
               <div class="col-lg-12">
                  <div class="card m-b-20">
                     <div class="card-block">
                        ...
                        <?php endif; ?>
                        <form  method="post" action="<?php echo base_url();?>advertisement/add_plan_history" name="advertisementform" id="aform" enctype="multipart/form-data" onSubmit='return check();'>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                             <label for="ecost" class="col-sm-2 col-form-label">Events <span class="error">*</span></label>
                            <div class="col-sm-4">
                                 <select name="event_id" class="form-control">
                                    <?php foreach ($adv_events as $values) { ?>
                                    <option value="<?php echo $values->id; ?>|<?php echo $values->category_id; ?>"> <?php  echo $values->event_name; ?>
                                    </option>
                                   <?php  } ?>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="form-group">
                              <label class="col-sm-4 col-form-label"></label>
							   <input type="hidden" class="form-control"  name="plan_id" value=" <?php echo $plan_id;   ?>">
                     ...
                     <div class="card-block">
                        ...
                        <table id="" class="table table-striped table-bordered" cellspacing="0" width="100%">
                           ...
                           <tbody>
						            <?php
                                $i=1;
                                foreach($adv_plan_history as $rows) {
                                  $status=$rows->status;
                                  $ahid=$rows->id;
                                ?>
                              <tr>
