...
Heyla acts as an agent to promote the events and sell tickets on behalf of the event organizers. We do not hold any control on the availability and pricing of the tickets.
               <br> <br><b>  Payment Confirmation</b><br>
                  ...
                  Once the payment is made and the booking is confirmed, you cannot make any changes in the order.  Kindly read the details of the event and eligibility before making the booking. We are not liable to make any refund for tickets purchased. <br><br>
If the event gets cancelled by the organizers of the event, we will refund the amount as per the policy of the organizer. If in case the event date has been changed by the organizer, we will contact you and proceed as per the policy of the organizer.<br><br>
Heyla  App may, in its discretion, attempt to mediate such dispute, however, we will have no liability for an Organizer’s failure to give refunds, our failure to mediate a dispute; or our decision if it does mediate the dispute.
                ...
                If there are any queries regarding your order, you can get in touch with us at <a href="mailto:hello@heylaapp.com">hello@heylaapp.com </a> / 9443471551. We assure you a response within one business day.
